    ...
    {             
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            {                
                ...
                if (!string.IsNullOrEmpty(hstsHeader) && NameValueWithParametersHeaderValue.TryParse(string.Join(";", hstsHeader.Split(';').Where(a => !string.IsNullOrEmpty(a))), out var parsedValue))
                {
